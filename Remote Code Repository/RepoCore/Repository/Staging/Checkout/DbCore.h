...
namespace NoSqlDb
{
  ...
  */
  inline void showHeader(bool showKey = true, std::ostream& out = std::cout)
  {
    ...
    out << std::setw(26) << std::left << "Name";
	out << std::setw(26) << std::left << "Author";
    out << std::setw(26) << std::left << "DateTime";
    out << std::setw(26) << std::left << "Description";
    out << "\n  ";
    if(showKey)
  ...
  void showRecord(const Key& key, const DbElement<P>& el, std::ostream& out = std::cout)
  {
    out << "\n  ";
    out << "*" << std::setw(26) << std::left <<key;
    out << std::setw(26) << std::left << el.name();
	out << std::setw(26) << std::left << el.author();
    out << std::setw(26) << std::left << std::string(el.dateTime());
    out << std::setw(26) << std::left << el.descrip().substr(0, 18);
	el.payLoad().showElementPayLoad(el);
